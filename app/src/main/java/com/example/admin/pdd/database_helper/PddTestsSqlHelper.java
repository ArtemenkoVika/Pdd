...
public class PddTestsSqlHelper extends SQLiteOpenHelper implements BaseColumns {
    ...
    public static final String DB_NAME = "tests_pdd.sqlite";
    ...
    private PddTestsSqlHelper(Context context) {
